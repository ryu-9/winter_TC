	...
	, _Life(8000)
{
	...
	_Model->SetPosition(VGet(50, -50, 0));
	...
	_MCollision = new MoveCollisionComponent(this, _Model, VGet(50, 0, 0), VGet(0.5, 0.5, 0.5), 6, false, true, handle);
	_HCollision = new HitCollisionComponent(this, _Model, VGet(50, 0, 0), VGet(75, 75, 75), 6, false, true);
}
