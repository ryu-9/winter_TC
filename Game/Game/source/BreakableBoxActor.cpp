	...
	, _Life(8000)
{
	...
	_MCollision = new MoveCollisionComponent(this, _Model, VGet(50, 50, 0), VGet(0.5, 0.5, 0.5), 6, false, true, handle);
	handle = ModelServer::GetInstance()->Add("res/cube.mv1");
	_HCollision = new HitCollisionComponent(this, _Model, VGet(50, 50, 0), VGet(0.5, 0.5, 0.5), 6, false, true,handle);
}
